    ...
    <div className={styles.container}>
      ...
      >
        ...
        >
          ...
          <div className="atcb">
            {"{"}
            "name":"Madeline and Junior Wedding", "description":"Madeline and
            Junior are starting their lives together.",
            "startDate":"2023-04-23", "endDate":"2023-04-23",
            "startTime":"13:05", "endTime":"18:00", "location":"STANARDSVILLE,
            VA", "label":"Add to Calendar", "options":[ "Apple", "Google",
            "iCal", "Microsoft365", "MicrosoftTeams", "Outlook.com", "Yahoo" ],
            "timeZone":"EST", "trigger":"click", "inline":true,
            "listStyle":"modal", "iCalFileName":"Reminder-Event"
            {"}"}
          </div>
        </div>
